...
var EnglishJapaneseDictionary = { ...PluginBase, ...{
...
export default EnglishJapaneseDictionary;LS-SPLITallPlugins.EnglishJapaneseDictionary = (() => { /// <reference types="lipsurf-types/extension"/>
var EnglishJapaneseDictionary = { ...PluginBase, ...{
    commands: {
        "Japanese Word Lookup": {
            pageFn: async (transcript, query) => {
...
return EnglishJapaneseDictionary;
 })()LS-SPLITallPlugins.EnglishJapaneseDictionary = (() => { /// <reference types="lipsurf-types/extension"/>
var EnglishJapaneseDictionary = { ...PluginBase, ...{
    commands: {
        "Japanese Word Lookup": {
            pageFn: async (transcript, query) => {
